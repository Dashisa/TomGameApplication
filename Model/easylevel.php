...
<head>
  ...
  <link rel="stylesheet" href="../View/Styles/game3.css">
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        message.innerHTML = 'Congratulations, Your answer is correct! Keep on the Tom Game!! ';
    ...
    if (numIncorrect >= 6) { 
      ...
      return;
        ...
        document.getElementById("score").textContent = score;
        message.innerHTML = "Incorrect answer, You have lose in the Tome Game!";
        message.style.color = 'white';
