...
<head>
  ...
  <link rel="stylesheet" href="../View/Styles/game2.css">
...
<body>
  ...
  <script>
    ...
    function handleInput() {
      ...
      if (input.value == solution) {
        ...
        message.innerHTML = 'Congratulations, Your answer is correct! Keep on the Tome Game!! ';
        ...
        document.getElementById("score").textContent = score;
        message.innerHTML = "Incorrect answer, You have lose in the Tom Game!";
        message.style.color = 'white';
    ...
    async function TomatoQuestion(data) {
      ...
      function handleTimeOut() {
        ...
        if (numQuestions >= 10) {
          ...
          alert("Time's up! You have lose in the Tom Game, Moving on to the next question.");
  ...
  <div class="questions" align="center">
    <div>
      ...
      <label for="quantity">
        <h2 style="color: white;">Enter the missing digit</h2>
      </label>
